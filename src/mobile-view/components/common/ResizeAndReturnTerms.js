...
const ResizeAndReturnTerms = () => {
    ...
    return(
        <div id='ReturnOrResizePolicy' style={{paddingLeft: '1.5em', paddingRight: '1.5em', paddingBottom: '1em'}}>
            <Collapse accordion bordered={true} style={{marginTop: '1em', paddingLeft: '1em'}}>
                <Panel showArrow={false} header="What is eligible for resize/return?">
                    <p><ol>
                ...
                <Panel showArrow={false} header="What is not eligible for resize/return?">
                    <p><ol>
                ...
                <Panel showArrow={false} header="How does the resize process work?">
                    <p><ol>
                ...
                <Panel showArrow={false} header="How does the return process work?">
                    <p><ol>
                        <li>Once the order is approved for return, our logistics partner will pick up the delivered item from the customer’s address.</li>
