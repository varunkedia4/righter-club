        ...
        <div style={{paddingTop: '3.5em'}}>
            ...
            <div id='FAQS' style={{paddingLeft: '1.5em', paddingRight: '1.5em', paddingBottom: '1em'}}>
                <Collapse accordion bordered={true}>
                    <Panel header="What is the ordering process of Righter?">
                    ...
                    <Panel header="Can we make changes to the designs listed on the platform?">
                    ...
                    <Panel header="What kind of outfits can we get on Righter?">
                    ...
                    <Panel header="Can I place a bulk order for my family?">
                    ...
                    <Panel header="What if I want to return/resize the product which I bought from Righter?">
                    ...
                    <Panel header="I have already given measurements in the past. Do I need to give measurements again to buy a product from Righter?">
                    ...
                    <Panel header="Which all cities Righter is operational in?">
