...
const PaymentPolicyPage = () => {
    ...
    useEffect(() => { document.title = pageTitles.PAYMENT_POLICY }, []);
    ...
    return(
        <div style={{paddingTop: '3.5em'}}>
            ...
            <Collapse accordion bordered={true} style={{marginTop: '1.5em', marginLeft: '1.5em', marginRight: '1.5em', marginBottom: '1.5em', paddingLeft: '1em'}}>
                <Panel showArrow={false} header="How can I pay on Righter?">
                    <p>
                ...
                <Panel showArrow={false} header="How does COD (Cash on Delivery) Payment option work?">
                ...
                <Panel showArrow={false} header="Is there a limit on the amount while using COD as a payment option?">
