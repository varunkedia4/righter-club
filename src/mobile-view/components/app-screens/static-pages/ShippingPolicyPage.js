    ...
    return(
        <div style={{paddingTop: '3.5em'}}>
            ...
            <Collapse accordion bordered={true} style={{marginTop: '1.5em', marginLeft: '1.5em', marginRight: '1.5em', marginBottom: '1.5em'}}>
                <Panel header="How do I check the status of my order?">
                ...
                <Panel header="How can I check if Righter delivers to my PIN Code?">
                    <p>Righter delivers at all the PIN Codes of Mumbai &amp; Bangalore.</p>
                </Panel>
                <Panel header="How are orders placed on Righter delivered to me?">
                    <p>All orders placed on Righter are dispatched through third party courier partners such as Blue Dart,
                        Delhivery, etc.</p>
                </Panel>
                <Panel header="Does Righter deliver products outside India?">
                    <p>No. At this point, Righter delivers products only within India.</p>
                </Panel>
                <Panel header="How can I get my order delivered faster?">
